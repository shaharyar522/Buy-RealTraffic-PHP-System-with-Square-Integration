...
//25 9 2018
    ...
    echo "<META HTTP-EQUIV='Refresh' CONTENT='2; URL=edit_users_new.php?ud=$uc_id&setemp=$err_msg&#SITE-LOGIN'>";
...
echo "<META HTTP-EQUIV='Refresh' CONTENT='0; URL=edit_users_new.php?ud=$uc_id&setemp=$err_msg&#SITE-LOGIN'>";
...
$page_content___bysatt = "<div align=center><b>#User Login Sites</b><br><br></div>";
