...
$l=$query = db_query("update users set cb_page_status='{$frm['cb_page_status']}'   , cb_purchase_date = '$cb_purchase_date',  cb_expire_date = '$cb_expire_date'   where  username='$term'  ");
...
<br>
click on the 'CB Page Stats' link underneath 'Stats'.  To add your 10 text
<br>
ads to your CB Money Page, click on the 'CB Text Ads' link under 
<br>
