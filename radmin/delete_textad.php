...
include'../config.php';
require_login_admin();
$title="$CONFIG->sitename Text ad  delete";
global $ce;
$ce=$_GET['id'];
...
<table  border=\"0\" class=text>
 ...
 <tr>
  ...
  <tr>
    <td colspan=\"2\">
	<input type=hidden name=ce value='$ce'><input type=submit class=button value=\"Delete This Text Ad\"></td>
  </tr>
</table></form>";
}//if
else
...
//satyajeet kesharia 29april 2018
 ...
 $s=db_query("delete from textads where id='$ce'");
//satyajeet kesharia 29april 2018
