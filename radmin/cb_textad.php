...
$query=db_query("select * from cb_textads where username='".$_SESSION['ADMIN']["admin"]["username"]."'");
...
<ul><li><a href=cb_add_textad.php class=link1>Add text ad </a></li></ul><br></div>";}
else
