...
$total_results = mysqli_result(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT COUNT(*) as Num FROM textads"), 0); 
...
$page_content="<div class=text id=heading  align=center><h4>User defined banners</h4></div>";
  ...
  $id=$from1;
$q= db_query("select * from textads order by id desc LIMIT $from, $max_results");
