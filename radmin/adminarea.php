...
if($login_sites == 0 && $traffic_sites == 0 ){
  $page_content .="<span style=font-size:15px; >There are No Login sites and No Traffic sites waiting for approval</span><br><br>";
                     }
...
if($login_sites != 0 && $traffic_sites != 0 ){
    $page_content .="<span style=font-size:18px;>There are ";  
    $page_content .= $login_sites . " Login sites And " . $traffic_sites;
    $page_content .=" Traffic sites waiting for approval</span>";
}
