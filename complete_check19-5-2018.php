...
$page_content= "<table align=center bgcolor=#d8ecff><tr><td><p class=text align=center>".$frm["firstname"].", Thank You for joining $CONFIG->sitename.<b> 



</b><br><br>Your Referral URL is:<br><a href=\"$CONFIG->siteurl/promo.php?from=".$frm["username"]."\" class=link1>$CONFIG->siteurl/promo.php?from=".$frm["username"]."</a><br><br>
To log into your account, click on the Login link at the top of this page.
<br><br>Your details have been sent to <b>".$frm["email"]."</td></tr></table></b><br> <br><br>";
//mail the user
