...
function add_solidtrustpay_new($cat,$ce,$inapoi,$one,$two,$three,$four,$five)
{
global $CONFIG;
...
<!--   <input type=hidden name="merchantAccount" value="instacom" >  -->
...
<input type=hidden name="merchantAccount" value="'.$ce.'" > 
    <input type=hidden name="amount" value="'.$cat.'" />
           <input type=hidden name="sci_name" value="EZMM"> 
<input type=hidden name="item_id" value="'.$five.'" />
