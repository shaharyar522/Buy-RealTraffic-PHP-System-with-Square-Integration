...
function add_paypal_new($cat,$ce,$inapoi,$one,$two,$three,$four)
{global $CONFIG;
...
<input type="hidden" name="item_number" value='.$CONFIG->paymentnote2.'>
...
function add_paypal($cat,$ce,$inapoi,$one,$two,$three,$four)
{global $CONFIG;
if($inapoi=='1'){$inapoi=$CONFIG->primu;}
if($inapoi=='2'){$inapoi=$CONFIG->adminul;}
if($inapoi=='3'){$inapoi=$CONFIG->complete;}
