...
//Site URL -please use the "http://www.3buckstofreedom.info" format.
$CONFIG->siteurl     = "http://www.sawbucksrandomizer.com";
...
$CONFIG->colorscheme  = "almost_green";
...
$CONFIG->support     = "admin@easycashrandomizer.com";

//Site name-this will be shown on the header,and footer,and also on every email sent
$CONFIG->sitename    = "EasyCashRandomizer.com";

//Memo (note) for the payments
$CONFIG->paymentnote="$CONFIG->sitename Membership Fee";
...
//    Use the same format          //
//              XX.XX              //
$CONFIG->adminfee="4.00";

//for sponsor
$CONFIG->sponsorfee="6.00";

//for random membbers
$CONFIG->randomfee="6.00";
