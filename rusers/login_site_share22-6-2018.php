...
function login_site_balance($sid){
    ...
    return $row_count_info[0];
	 ...
	 $sql_xyz = "SELECT * FROM url_unassigned_login_credits WHERE user_id =55";
...
/////////////////////////////////-----CURRENT USER POINTS--------////////////////////////url_user_balance
           $curr_ac_pts  = (int) $row_xyz['login_credits'];
           //echo '$curr_ac_pts => ' . $curr_ac_pts;
////////////////////////////-----CURRENT TABLE POINTS--------////////////////////////url_points
...
///////////////////////////////----- VALIDATION BEGINS-----------///////////////////////
   ...
   if($err_msg_pt == ""){
      ...
      #$My_Pending_Points = ($loggin_user_points - $curr_frm_pts);
  	  //  $sql_req = "UPDATE url_unassigned_login_credits SET login_credits = '$Pending' WHERE user_id =".$_SESSION["user"]["id"]; 
  	    $sql_req = "UPDATE url_unassigned_login_credits SET login_credits = '$Pending' WHERE user_id =55"; 
       ...
       //After Error
        ...
        for($w=0;$w<$number_of_ids;$w++){
             echo  $ups_del = "UPDATE url_login_clicks set points = '$spointx[$w]' WHERE site_id = '$sidx[$w]' limit 1"; exit;
 ...
 $page_content ='<div id="column_w610" style="width:800px">
