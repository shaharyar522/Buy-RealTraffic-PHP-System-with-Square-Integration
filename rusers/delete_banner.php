...
$page_content="<div class=text id=heading  align=center><b>Delete Banner</b><br><br></div>";
if(!$_POST){
...
<table align=\"center\" class=\"shadowed\" class=text width-\"100%\" bgcolor=\"#d8ecff\" valign=top cellpadding=\"5\" cellspacing=\"0\" border=\"1\" style=\"border-collapse: collapse\" id=\"AutoNumber1\" bordercolor=\"#999999\">
 ...
 <tr>
  ...
  <tr>
    <td colspan=\"2\">
	<input type=hidden name=ce value='$ce'><input type=submit class=button value=\"Delete This Banner\"><br><br></td>
  </tr>
</table><br><br> </td></tr></table></form>";}
}//if
else
{$ce=$_POST['ce'];
$s=db_query("delete from banners where id='$ce' and username='".$_SESSION["user"]["username"]."'");
$page_content.="<div class=text align=center><br><br>Banner settings updated.<br><br></div>";
