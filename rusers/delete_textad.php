...
include'../config.php';
require_login();
$title="$CONFIG->sitename Delete Text Ad";
global $ce;
$ce=$_GET['id'];
include("$CONFIG->templatedir/header.php");
$page_content="<div class=text id=heading  align=center><b>Delete Text Ad</b><br><br></div>";
if(!$_POST){
...
$page_content.=
"<form action=delete_textad.php method=post>
...
<table align=\"center\" class=\"shadowed\" class=text width-\"100%\" bgcolor=\"#d8ecff\" valign=top cellpadding=\"5\" cellspacing=\"0\" border=\"1\" style=\"border-collapse: collapse\" id=\"AutoNumber1\" bordercolor=\"#999999\">
 ...
 <tr>
  ...
  <tr>
    <td colspan=\"2\">
	<input type=hidden name=ce value='$ce'><input type=submit class=button value=\"Delete This Text Ad\"><br><br></td>
  </tr>
</table> <br><br> </td></tr></table></form>";}
}//if
else
{$ce=$_POST['ce'];
$s=db_query("delete from textads where id='$ce' and username='".$_SESSION["user"]["username"]."'");
