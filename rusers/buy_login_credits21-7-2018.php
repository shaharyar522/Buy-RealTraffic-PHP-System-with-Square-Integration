...
$sql = "SELECT cost_per_unit, login_cost_per_hundred, vc_log_email, vc_log_security_code, login_cancel_url, login_return_url,paypal_email  FROM url_site_setting";
...
if (isset($_POST['mode'])) {
	...
	$payza_button = str_replace('[user_id]', $_SESSION['user_id'], $payza_button);
	$payza_button = str_replace('[first_name]', $_SESSION['fname'], $payza_button);
	$payza_button = str_replace('[last_name]', $_SESSION['lname'], $payza_button);
	$payza_button = str_replace('[vc_log_email]', $vc_log_email, $payza_button);
	$payza_button = str_replace('[login_item_name]', "Login Credits", $payza_button);
