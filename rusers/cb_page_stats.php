...
If you would like to make money selling ClickBank\'s top 15 money-making prouducts, click on the "Buy CB Money Page" link underneath "Paid Services" above for details.
<br></span>',
 $page_content);
                                             }
...
//$page_content=str_replace('<td align="center" id="id4"></td>', '<td align="center" id="id1">'.$fill["id"].'</td>' ,$page_content);


$page_content=str_replace('<td align="center" id="id5"></td>', '<td align="center" id="id1">'.$fill["cb_purchase_date"].'</td>' ,$page_content);
$page_content=str_replace('<td align="center" id="id6"></td>', '<td align="center" id="id1">'.$fill["cb_expire_date"].'</td>' ,$page_content);




$page_content=str_replace('theid', $fill["id"] ,$page_content);
...
$page_content=str_replace('<input name="button" type="button" value="Reset" onClick=getData("http://www.ez-moneymaker.com/rusers/cb_page_stats_reset.php?id=theid") >','',$page_content);
