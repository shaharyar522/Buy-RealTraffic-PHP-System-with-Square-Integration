...
//   login_cost_per_hundred   replaced by   traffic_cost_per_thousand     23 12 2023
$sql = "SELECT item_name,cost_per_unit, traffic_cost_per_thousand, vc_log_email, vc_log_security_code, login_cancel_url, login_return_url,paypal_email ,min_traffic_credits ,min_login_credits ,merchant_login_id ,merchant_transaction_key,payment_g_type  FROM url_site_setting";
...
if (isset($_POST['mode'])) {
	$value = "1";
	$traffic_credits = $_POST['amount'];
	$amount = ($traffic_credits / 1000) * $traffic_cost_per_thousand; 
    $amount = sprintf ("%.2f", $amount);
	$_SESSION['login_credits_purchased'] = $traffic_credits;
    $payza_button = '';
	...
	$payza_button = str_replace('[login_quantity]', $traffic_credits, $payza_button);
	$payza_button = str_replace('[login_quantity1]', $traffic_credits, $payza_button);
...
<center><h3>Buy Traffic Credits</h3></center>
...
<? if ($value== 0){ ?>
   ...
   <p align="center"><b><div class="header_01" align=center> User ID: <?     echo $_SESSION['user']['username'] ?>  - Buy Traffic Credits
<br>
...
<!-- <br><font color="red">COMING SOON!</font> -->
      ...
      <p align="center"> The cost of Traffic Credits is <span style="color: red; font-weight: bold;">$<? echo $traffic_cost_per_thousand; ?></span> per 1000 Traffic Credits.</p> 
   
        <p align="center"><font color=red></font></p>
  
       <form name="frm1" action="buy_traffic_credits.php#form_down" method="post" onsubmit="return validateForm()">     
          ...
          <table border="0"  cellpadding="10" cellspacing="0" width="100%" align=center style=" border: 1px solid #808080;font-size: 14px;">
             ...
             <tr class="listtabletoprow">
		        <td colspan="3" align="center" class='textbld' bgcolor="#1B476E"><font color="#FFFFFF">Buy Traffic Credits</font></td>
 	         </tr>       

             <tr bgcolor="#e9edf6">        <td width="60%"><font size="2">&nbsp;&nbsp;Enter the number of Traffic Credits to purchase. <br>&nbsp;&nbsp;Note: Please do not enter commas:</font></td>

  <td width="40%"><input type="text" name="amount" id="amount" value="" class="TextBoxSmall" maxlength="5"/></td>
             </tr> 

             <tr bgcolor="#d0d7e7">
              <td><font size="2">&nbsp;&nbsp;Payment Type:</font></td>
              <td>
...
<script>
var minTrafficCredits = <?php echo $row['min_traffic_credits']; ?>;
        function validateForm() { 
            ...
            if (amount < minTrafficCredits) {
            alert('Sorry, the minimum number of Traffic Credits you can purchase is : ' + minTrafficCredits);
            return false; // Prevent form submission
            }
      ...
      <form action="https://secure.payza.com/checkout" method="post" name="payment"></form>    
       ...
       <table border="0" cellpadding="10" cellspacing="0" width="100%" align=center style=" border: 1px solid #808080;font-size: 14px;">
         <tr>     
             ...
             <td colspan="3" align="center" class='textbld' bgcolor="#1B476E"><font face="verdana" color="#FFFFFF">Purchase Traffic Credits For User ID: <? echo $_SESSION['user']['username'] ?> </font></td>
         </tr>            

         <tr bgcolor="#e9edf6" colspan="3">     

            <td width="40%" align="left"><font size="2"><? echo $traffic_credits; ?> Traffic Credits @ $<? echo $traffic_cost_per_thousand; ?> per 1000 Traffic Credits </font></td>
...
<tr bgcolor="#e9edf6" colspan="3"> 
            ...
            <td>
                ...
                <input type="hidden" name="item_id" value="<? echo $traffic_credits; ?> Traffic Credits @ $<? echo $traffic_cost_per_thousand; ?> per 1000 Traffic Credits" />
                <input type="hidden" name="user9" value="1" /> 
                <input type="hidden" name="page_name" value="buy_traffic_credits" /> 
                ...
                <input type="hidden" name="user1" value="<? echo $traffic_credits; ?>" />
...
<form method="post" action="https://www.buy-realtraffic.com/process-payment.php"">
        ...
        <input type=hidden name="item_id" value="<? echo $traffic_credits; ?> Traffic Credits @ $<? echo $traffic_cost_per_thousand; ?> per 100 Traffic Credits" />
        <input type=hidden name="user9" value="1" /> 
        <input type=hidden name="page_name" value="buy_traffic_credits" /> 
        <input type=hidden name="user5" value="<? echo $_SESSION['user']['username'] ?>" />
        <input type=hidden name="user1" value="<? echo $traffic_credits; ?>" />
	...
	<table align="center" class="shadowed"  width="100%" bgcolor="#d8ecff" valign=top cellpadding="5" cellspacing="0" border="1" style="border-collapse: collapse" id="AutoNumber1" bordercolor="#999999">
        ...
        <tr>
            <td width="40%" align="left" class=text > 
                <div align="right"><span class="barreclair"> <label for="card_number">Card Number:</label>:</span> 
                </div>
            </td>
            <td width="65%" align="left" class=text >
                <input type="text" name="card_number" value="4111111111111111" required>
           </td>
        </tr>
        <tr>
            <td width="40%" align="left" class=text > 
                <div align="right"><span class="barreclair"> <label for="expiration_date">Expiration Date (MM/YY):</label>:</span> 
                </div>
            </td>
            <td width="65%" align="left" class=text >
                <input type="text" name="expiration_date" value ="12/24" placeholder="MM/YY" required>
           </td>
        </tr>
        <tr>
            <td width="40%" align="left" class=text > 
                <div align="right"><span class="barreclair"> <label for="cvv">CVV:</label>:</span> 
                </div>
            </td>
            <td width="65%" align="left" class=text >
        ...
        <tr>
            <td width="40%" align="left" class=text > 
                <div align="right"><span class="barreclair"> <label for="amount">Amount:</label>:</span> 
                </div>
            </td>
            <td width="65%" align="left" class=text ><? echo $amount; ?>
                <input type="hidden" name="amount" value="<? echo $amount; ?>" readonly required>
        ...
        <tr>
            <td width="40%" align="left" class=text > 
                <div align="right"><span class="barreclair"> <label for="x_email">Email Address:</label>:</span> 
                </div>
            </td>
            <td width="65%" align="left" class=text >
                <input type="text" name="x_email" value="<? echo $_SESSION['user']['email'] ?>" />
           </td>
        </tr>

        <tr>
            <td width="40%" align="left" class=text > 
                <div align="right"><span class="barreclair"> <label for="x_first_name">First Name:</label>:</span> 
                </div>
            </td>
            <td width="65%" align="left" class=text >
                <input type="text" name="x_first_name" value="<? echo $_SESSION['user']['firstname']  ?>" />
           </td>
        </tr>
        ...
        <tr>
            <td width="40%" align="left" class=text > 
                <div align="right"><span class="barreclair"> <label for="x_last_name">Last Name:</label>:</span> 
                </div>
            </td>
            <td width="65%" align="left" class=text >
                <input type="text" name="x_last_name" value="<? echo $_SESSION['user']['lastname']  ?>" />
           </td>
        </tr>
        ...
        <tr>
            <td width="40%" align="left" class=text > 
                <div align="right"><span class="barreclair"> <label for="x_address">Address:</label>:</span> 
                </div>
            </td>
            <td width="65%" align="left" class=text >
        ...
        <tr>
            <td width="40%" align="left" class=text > 
                <div align="right"><span class="barreclair"> <label for="x_city">City:</label>:</span> 
                </div>
            </td>
            <td width="65%" align="left" class=text >
        ...
        <tr>
            <td width="40%" align="left" class=text > 
                <div align="right"><span class="barreclair"> <label for="x_state">State:</label>:</span> 
                </div>
            </td>
            <td width="65%" align="left" class=text >
...
:
        <tr>
            <td width="40%" align="left" class=text > 
                <div align="right"><span class="barreclair"> <label for="x_zip">Zip Code:</label>:</span> 
                </div>
            </td>
            <td width="65%" align="left" class=text >
        ...
        <tr>
            <td width="40%" align="left" class=text > 
                <div align="right"><span class="barreclair"> <label for="x_country">Country:</label>:</span> 
                </div>
            </td>
            <td width="65%" align="left" class=text >
        ...
        <tr>
            <td width="40%" align="left" class=text > 
                <div align="right"><span class="barreclair"> <label for="p_number">Phone Number:</label>:</span> 
                </div>
            </td>
            <td width="65%" align="left" class=text >
...
<br>
2)  In the amount field, enter the Amount: <b> $<?php //echo  $traffic_credits * $traffic_cost_per_thousand / 100  ;   

          echo  number_format((float)$traffic_credits * $traffic_cost_per_thousand / 100, 2, '.', '');
?>  </b>
<br>

<tr bgcolor="#e9edf6"> <br><td><br>
3)  Copy the Admin's Venmo username <b><?php echo $admin_venmo_username;  //echo $_SESSION['user']['venmo_username'] ?></b> and paste it into the "To" field.
<br>

</td></tr>
  <tr bgcolor="#d0d7e7"><td><br>
4)  Copy this Note:  <b> <? echo $traffic_credits; ?>  Traffic Credits For User:  <? echo $_SESSION['user']['username'] ?> (<? echo $_SESSION['user']['firstname'] .' '. $_SESSION['user']['lastname'] ?>)</b> and paste it into the "Note" field and click the Pay button.  Once you have 
