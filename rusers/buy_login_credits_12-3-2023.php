      ...
      <form action="https://secure.payza.com/checkout" method="post" name="payment"></form>    
       ...
       <table border="0" cellpadding="10" cellspacing="0" width="100%" align=center style=" border: 1px solid #808080;font-size: 14px;">
         <tr>     
             ...
             <td colspan="3" align="center" class='textbld' bgcolor="#1B476E"><font face="verdana" color="#FFFFFF">Purchase Login Credits For User ID: <? echo $_SESSION['user']['username'] ?> </font></td>
         </tr>            
...
<br>
2)  In the amount field, enter the Amount: <b>THE AMOUNT GOES HERE (AMOUNT = (login_cost_per_hundred/100) * The number of login credits purchase</b>
<br>

<tr bgcolor="#e9edf6"> <br><td><br>
3)  Copy the Admin's Venmo username <b>ADMIN VENMO USERNAME GOES HERE(admin_venmo)</b> and paste it into the "To" field.
<br>

</td></tr>
  <tr bgcolor="#d0d7e7"><td><br>
4)  Copy this Note:  <b>For Example 200 Login Credits For User:  %username% (%firstname% %lastname%)</b> and paste it into the "Note" field and click the Pay button.  Once you have 
...
<br>
2)  In the amount field, enter the Amount: <b> $<?php echo  $login_credits * $login_cost_per_hundred / 100  ;   ?>  </b>
<br>

<tr bgcolor="#e9edf6"> <br><td><br>
3)  Copy the Admin's Venmo username <b><?php echo $_SESSION['user']['venmo_username'] ?></b> and paste it into the "To" field.
<br>

</td></tr>
  <tr bgcolor="#d0d7e7"><td><br>
4)  Copy this Note:  <b> 200 Login Credits For User:  <? echo $_SESSION['user']['username'] ?> (<? echo $_SESSION['user']['firstname'] .' '. $_SESSION['user']['lastname'] ?>)</b> and paste it into the "Note" field and click the Pay button.  Once you have 
completed your payment to the admin, come back to this page and click the "Continue" button below.
<br>
</td></tr>
<tr bgcolor="#e9edf6"><td><br>
