...
"<a class=link1 href=$CONFIG->siteurl/rusers/ref_details.php?time=free>".$free_mem["numar"]."</a>"
:$free_mem["text"]=" No referrals yet";

($pro_mem["numar"]>=1)?$pro_mem["text"]=
"<a class=link1 href=$CONFIG->siteurl/rusers/ref_details.php?time=pre>".$pro_mem["numar"]."</a>"
...
<p align=center class=text>
  <h3 align=center>Direct Referrals For User  <b>".strtoupper($_SESSION["user"]["username"])."</h3><br><br></b>
