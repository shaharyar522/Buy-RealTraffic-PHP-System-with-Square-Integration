...
//$q1=db_fetch_array(db_query("select username , paypal ,stormpay,egold,libertyreserve ,assuredpay from users where id='1'"));
if(($CONFIG->allowpaypal)&&(validate_email($rss123["paypal"]))){$page_content.=add_paypal($CONFIG->sponsorfee+$CONFIG->adminfee,$rss123["paypal"],"3"   ,$rss123["username"],$rss123["email"],$rss123["firstname"],$rss123["lastname"]  );}
                                                               }else{
