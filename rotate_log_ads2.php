...
<!--<div class="top-bar-1">
	...
	<div class="cent" style=" display: table;   margin: 0 auto;  padding-top: 15px;">
	<div style="  float: left;  padding-right: 15px;" id="counter" class="<? echo $login_timer ;?>" align="center"></div>


	
	<div id="dialog-second" style="display: none; float: left;
    padding-top: 4px;" >
		
		<!--<a href="user_home.php" alt="Member's Area"><img border="0" alt="" src="images/member-area.png"  style="    border: solid 1px #C3C3C3;
    border-radius: 5px;margin-right: 10px;"></a>-->
	<!--<a href="<? echo $admin_site; ?>" target="_blank" alt="Open Site in new tab"><img border="0" alt="" src="images/open-site.png" style="    border: solid 1px #C3C3C3;
    border-radius: 5px;margin-right: 10px;" onclick="navigate()"></a>-->
