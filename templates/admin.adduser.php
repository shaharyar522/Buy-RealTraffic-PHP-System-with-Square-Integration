<table width="100%" border="1" cellspacing="0" cellpadding="0"  border="0" cellspacing="0" cellpadding="3" class="text" >
        ...
        <tr id=heading>
          <td colspan="2" align=center  class=text ><strong>Add a user by filling the following form<br>
        ...
        <tr>
          <td align="right" class=text >alertpay email:</td>
		...
		<tr>
          <td align="right" class=text >Fleetpay ID</td>
