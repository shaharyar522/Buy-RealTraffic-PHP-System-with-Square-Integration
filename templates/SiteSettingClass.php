...
class SiteSetting{
   ...
   // var $merchant_login_id;
//    var $merchant_transaction_key;
...
if (array_key_exists("merchant_login_id", $p_array)) {
	$this->merchant_login_id = trim($p_array['merchant_login_id']) ;
}

if (array_key_exists("merchant_transaction_key", $p_array)) {
	$this->merchant_transaction_key = trim($p_array['merchant_transaction_key']) ;
}

if (array_key_exists("payment_g_type", $p_array)) {
	$this->payment_g_type = trim($p_array['payment_g_type']) ;
}
		...
		if (array_key_exists("login_cost_per_thousand", $p_array)) {
			$this->login_cost_per_thousand = $p_array['login_cost_per_thousand'] ;
		}
...
//days_cb_page_last
            ...
            traffic_item_name		 = '$this->traffic_item_name',
        traffic_cost_per_thousand		 = '$this->traffic_cost_per_thousand',
            traffic_sites_allowed		 = '$this->traffic_sites_allowed',
            min_traffic_credits		 = '$this->min_traffic_credits',
            min_login_credits		 = '$this->min_login_credits',
            
            merchant_login_id		 = '$this->merchant_login_id',
            merchant_transaction_key		 = '$this->merchant_transaction_key',
            
            payment_g_type		 = '$this->payment_g_type',
            
            
                                    bulk_email		 = '$this->bulk_email',
                                            paypal_email = '$this->paypal_email',
                                 login_cost_per_thousand   = '$this->login_cost_per_thousand',                                                     
...
$this->merchant_login_id            = $row->merchant_login_id;
$this->merchant_transaction_key            = $row->merchant_transaction_key;

$this->payment_g_type            = $row->payment_g_type;
				...
				$this->login_cost_per_thousand = $row->login_cost_per_thousand;
