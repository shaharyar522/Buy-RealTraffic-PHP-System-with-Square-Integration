...
You can add multiple referral urls.  Each referral url will cost <b>cost_per_referral_url</b> and each referral url will stay in rotation for <b>days_url_rotator_last</b> days.
...
<? if ($value== 0){ ?>
   ...
   <p align="center"><b><div class="header_01" align=center> User ID# %username% - Buy Traffic Rotator Url 
...
<br>
   ...
   <!--   <p align="center"> The cost of a Referral Url is <span style="color: red; font-weight: bold;">cost_per_referral_url </span> Per Referral Url.</p>  -->
<!-- 3-3-2023 -->
          <p align="center"> The cost of a Referral Url is <span style="color: red; font-weight: bold;">$%login_cost_per_hundred%</span> Per Referral Url.</p>
...
<br>
2)  In the amount field, enter the Amount: <b>THE AMOUNT GOES HERE (AMOUNT = The number of urls purchased * cost_per_referral_url)</b>
<br>
...
4)  Copy this Note:  <b>For Example 2 Referral Urls For User:  %username% (%firstname% %lastname%)</b> and paste it into the "Note" field and click the Pay button.  Once you have 
