<?php 
  ...
  #b => tb_site
    ...
    $sel_all = "SELECT
                ...
                FROM
                          traffic_clicks a, traffic_sites b
                WHERE
                          (a.site_id = b.sid)
                AND
                          (b.status = 'L')
    ...
    if($num_all > 0){
       ...
       //----------------------------------------------------------------------------------------------------//
           ...
           if($num_rex > 0){
              ...
              //reduce the points------------------------------------------------------------
              $reduce_sql = "UPDATE traffic_clicks SET   points       = points-1, 
            ...
            //  update_textAdds_status($id);
              ...
              //Lock the updater------------------------------------------------------------
              $update_lock_sql = "update traffic_sites set cron = 'DONE' WHERE  sid = ".$row_rex['site_id'];
              ...
              *****************************************/
              ...
              $query_select_site  = "SELECT * FROM traffic_clicks WHERE user_id = '$user_id'";
              ...
              $query_zero_site    = "SELECT * FROM traffic_clicks WHERE user_id = '$user_id' AND points = '0'";
            ...
            //  $smarty->assign("table", "traffic_sites");
       ...
       //UnLock the updater------------------------------------------------------------
       $update_unlock = "update traffic_sites set cron = 'NEED' WHERE  cron = 'DONE' AND status = 'L' ";
       ...
       //----------------------------------------------------------------------------------------------------//
           ...
           $sel_max = "SELECT
            ...
            if($num_max > 0){
              ...
              $reduce_sql = "UPDATE traffic_clicks SET 
  ...
  //	======================== UPDATE STATUS OF BANNERS AND TEXT ADS ===========================================================
            ...
            //  update_textAdds_status($user);
              ...
              //Lock the updater------------------------------------------------------------
              $update_sql_lock = "update traffic_sites set cron = 'DONE' WHERE  sid = '{$row_max['site_id']}'";
...
<div>
 ...
 <iframe src="<? echo $admin_site; ?>" style="height: 100%; width: 100%;"></iframe>  
  ...
  <script type="text/javascript">
	...
	function navigate(){
		/*alert("adsf");*/
		window.location='/rusers/traffic_sites.php';
	}
